...
class Queries(BaseModel):
    """Model for structured search query generation output.

    This class defines the structure for search queries generated by the LLM
    to research information about a person based on the extraction schema.
    """
    ...
    try:
        ...
        if "Prior Companies:" in reflection_content:
            ...
            if companies_line.lower() not in ["unknown", "unclear"]:
                ...
                extracted_info["prior_companies"] = [
                    {
                        "company": companies_line,
                        "role": "Unknown",
                        "duration": "Unknown",
                    }
                ]
