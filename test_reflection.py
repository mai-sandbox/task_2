    ...
    try:
        ...
        with patch("src.agent.graph.claude_3_5_sonnet") as mock_llm:
            ...
            validations = [
                ...
                (
                    "prior_companies",
                    result["prior_companies"],
                    list,
                    ["Microsoft", "Amazon", "TechCorp"],
                ),
                ...
                (
                    ...
                    result["missing_info"],
                    list,
                    ["Education background", "Specific projects"],
                ),
                ...
                (
                    ...
                    result["reasoning"],
                    str,
                    "Core professional information is well documented with clear career progression.",
                ),
            ]
            ...
            for field_name, actual_value, expected_type, expected_value in validations:
                if not isinstance(actual_value, expected_type):
                    print(
                        f"❌ {field_name}: Expected type {expected_type.__name__}, got {type(actual_value).__name__}"
                    )
                    return False
